...
public class armPIDCommandBallBack extends Command {
  ...
  /** Creates a new armPIDCommandBallBack. */
  public armPIDCommandBallBack(ArmSubsystem armSubsystem) {
  ...
  @Override
  public void execute() {
    m_ArmSubsystem.m_GrabberMotor.set(-.27);
